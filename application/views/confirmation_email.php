<!DOCTYPE html> <!-- Created by Ganesh BS - Confirmation Email View-->
<html lang="en">
    <head>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row vertical-center-row">
                <div class="container-fluid">
                    <div class="row"><input type="hidden" name="email" value="<?php echo $email ?>"/>
                        <div class="col-md-6 col-md-offset-3">
                            <?php
                            if (isset($email_response)) {
                                if ($email_response === "yes") {
                                    ?>
                                    <b>Thanks for Joining <span style="color:firebrick; font-size: 16px;">Bulkhouse.in</span>. <br/>Please click on the activation link sent to your mailbox : <span style = "color:firebrick; font-size:15px;"><?php
                                            if (isset($email)) {
                                                echo $email;
                                                ?>
                                    ...
                                    <br/>
                                    <center>
                                        <span style="font-size:12px;">The Activation link will expire within 24 hours.</span>
                                    </center>
                                    <?php
                                } else if ($email_response === "no") {
                                    ?>

                                    <b style="color:red">Mail Cannot be sent..Please Try again..! Thank you</b>
                                    <br/>
                                    <br/>
                    ...
                    <div class="row">
                        <div class="container">
                            ...
                            <div class="alert alert-danger" id="error_message" style="display:none">
                                Sorry.. verification link cannot be sent. Please try again..!
                            </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row" style="font-size:11px;">
                        <div class="col-md-6 col-md-offset-3">
                            <b>If you have not received your mail?</b>
                            ...
                            <ul>
                                ...
                                <li id="resend">
                                    Please <a href="#" onclick="resend()">Click Here</a> to resend the activation link
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <script>
                                        function resend() {
                                            ...
                                            $.post("<?php echo base_url() ?>register/send_activation_link", {email: $("#email").val()}, function (data) {
