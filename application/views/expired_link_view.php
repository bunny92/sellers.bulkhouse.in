        ...
        <div class="container-fluid">
            <div class="row vertical-center-row">
                ...
                <div class="col-md-6 col-md-offset-3">
                    <center>
                        <b style="color:red">Your Activation Link is Expired.. If possible please Register with a new email-id</b>
                    </center>

                    <center>
                    <span style="font-size:11px;">Have Problems with signing in.. Please contact our Administrator</span>
                    </center>
                    <br/>
                    <br/>
                </div>
