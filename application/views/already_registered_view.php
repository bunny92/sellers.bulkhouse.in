<!DOCTYPE html>
<html lang="en">
    <head> <!-- Created by Ganesh BS - Already Registered View-->
        <meta charset="utf-8">
        ...
        <div class="container-fluid">
            <div class="row vertical-center-row">
                ...
                <div class="col-md-6 col-md-offset-3">
                    <b>Thanks for visiting <span style="font-size:16px; color: firebrick">Bulkhouse.in</span></b>
                    <br/>
                    <b>The email address you have entered has already been registered. Please click on the activation link sent to your mail : <span style="color:firebrick"><?php echo $email?></span></b> <input type="hidden" id="email" value="<?php echo $email?>"/> 
                    <br/>
                    <br/>
                </div>
                </div>
                ...
                <div class="col-md-6 col-md-offset-3">
                    <b>Struck Signing In/Accessing Activation Link</b>
