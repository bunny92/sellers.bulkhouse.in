    ...
    <div class="row">
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            <div class="account-wall">
                ...
                <p class="profile-name">Forgot Password</p>
                <br/>
                <form class="form-signin" method="post" action="<?php echo base_url()?>welcome/send_mail">
                    <input type="email" name="email" class="form-control" placeholder="Email Address" required autofocus><br/>
                <button class="btn btn-lg btn-danger btn-block" type="submit">
                    Get Password</button>
                <a href="<?php echo base_url()?>" class="need-help">Login </a><span class="clearfix"></span>
                </form>
            </div>
      ...
      <?php
        if($this->session->flashdata("yes") !== NULL) {
          ?>
          <div class="alert alert-success">
          <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
          <?php
          echo $this->session->flashdata("yes");
          ?></div> <?php
        }
      ?>
