                ...
                <div class="col-md-8 col-md-offset-2">
                    <div class="stepwizard">
                        <div class="stepwizard-row setup-panel">
                            ...
                            <div class="stepwizard-step">
                                <a href="#" type="button" class="btn  btn-danger btn-default btn-circle" disabled="disabled">2</a>
                                <p>Profile</p>
                            </div>

                            <div class="stepwizard-step">
                                <a href="#" type="button" class="btn  btn-danger btn-default btn-circle">3</a>
                                <p>Complete</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6 col-md-offset-3">
                            ...
                            if (isset($response)) {
                                if ($response === "yes") {
                                    ?>
                            <center>
                                <b style="font-size:18px;"><i>Thanks for registering with </i><span style="font-size:16px; color: firebrick">Bulkhouse.in</span></b>
                            </center>
                                    <br/>
                                    <b style="font-size:12px;">Thank you for registering with Bulkhouse. Now generate greater demand from around the world through our single listing and multiple market places.  Please <a href="<?php echo base_url() ?>">Login</a> to complete your Profile Details</b>
                                    <br/>
                                    <br/>
                                    <?php
                                } else if ($response == "no") {
                                    ?>
                                    <b style="color:red">Sorry your account is not registered. We are facing technical issues kindly visit the site after an hour. </b>
                                    <br/>
                                    <b>Please Contact Admin for assistance. Thank you for visiting <span style="color:firebrick">BULKHOUSE</span></b>
                                    <br/>
                                    <br/>
