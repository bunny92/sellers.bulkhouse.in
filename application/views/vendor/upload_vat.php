...
<script type="text/javascript">(function(d,n){var s,a,p;s=document.createElement("script");s.type="text/javascript";s.async=true;s.src=(document.location.protocol==="https:"?"https:":"http:")+"//cdn.nudgespot.com"+"/nudgespot.js";a=document.getElementsByTagName("script");p=a[a.length-1];p.parentNode.insertBefore(s,p.nextSibling);window.nudgespot=n;n.init=function(t){function f(n,m){var a=m.split('.');2==a.length&&(n=n[a[0]],m=a[1]);n[m]=function(){n.push([m].concat(Array.prototype.slice.call(arguments,0)))}}n._version=0.1;n._globals=[t];n.people=n.people||[];n.params=n.params||[];m="track register unregister identify set_config people.delete people.create people.update people.create_property people.tag people.remove_Tag".split(" ");for(var i=0;i<m.length;i++)f(n,m[i])}})(document,window.nudgespot||[]);nudgespot.init("a3b2a04cb8a634716c8f7a599784a8c8");
  ...
  var activity_name = "Seller_vat_document_submited";
   nudgespot.track(activity_name);
    ...
    <body>
        ...
        <div  id="nav_bar">
            ...
            <nav class="red" >
                <a href="<?php echo base_url() ?>vat_document" class="brand-logo center">Document - VAT/CST</a>
                <ul class="left">
        ...
        <main>
            ...
            <div class="row">
                <div class="col m5 offset-m1">
                    <span class="page-title"><?php echo $profile->vat_status === "Approved" ? "Your" : "Please upload your " ?>  VAT/CST</span>
                    <br/>
                    <span class="page-sub-title">
                        <br/>
                        <?php echo $profile->vat_status === "Approved" ? "Your document is sucessfully approved" : "Please upload the valid document and wait for verification. If there exists any ambiguilty,our customer care expert will reach you shortly " ?>
                    </span>
                    <br/>
                    <?php
                    $photo_id = "";
                    ...
                    if ($profile->vat_status === 'N/A') {
                        ...
                        $photo_id = $profile->input_vat_cst;
                        $photo_url = $profile->vat_cst;
                    }
                ...
                <?php if ($profile->vat_status !== "Approved") {
                    ?>
                    <div class="col m5 offset-m1">
                        <div class="card-panel">
                            <form method="post" enctype="multipart/form-data" action="<?php echo base_url() ?>vat_document/upload_document" onsubmit="return validate_form()">
                                <input type="hidden" name="doc_type" value="vat_cst"/>
                                <div class="row">
                                    <div class="input-field col s12">
                                        ...
                                        <label for="input_photo_id">Enter VAT_CST:</label>
        ...
        <script type="text/javascript">
                                function validate_form() {
                                    ...
                                    if (pic_id.trim().length < 5) {
                                        $("#photo_id_error").html("Please enter valid VAT/CST ID");
                                        flag = false;
                                    }
