                ...
                <div class="col l4 offset-l1 s12 m12">
                 ...
                 <div class="col s12 l6 m8 offset-m2">
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <span class="page-title">4. Partnership Deed</span>
                            <div class="container">
                                <p class="page-sub-title">
                                    <span class="green-text text-darken-1"><?php
                                        if ($this->session->flashdata("deed_message") !== NULL) {
                                            echo $this->session->flashdata("deed_message");
                                        }
                                        ?></span><br/>
                                    Format : PDF Only <br/>

                                    <span class="indigo-text text-darken-4">Status : <?= $profile->deed_status === 'N/A' ? "Please Upload" : $profile->deed_status ?></span><br/><br/>
                                    <button onclick="document.location.href = '<?php echo base_url() ?>deed_document'" class="btn red white-text" style="font-size: .8em; text-transform: capitalize"><?php
                                        if ($profile->deed_status === 'N/A') {
                                            echo "Upload";
                                        } else if ($profile->deed_status === 'Approved') {
                                            echo "View";
                                        } else {
                                            echo "Edit";
                                        }
                                        ?> Partnership Deed</button>
                                </p>
                            </div>
                        </div>
