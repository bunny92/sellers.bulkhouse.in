...
<script type="text/javascript">(function(d,n){var s,a,p;s=document.createElement("script");s.type="text/javascript";s.async=true;s.src=(document.location.protocol==="https:"?"https:":"http:")+"//cdn.nudgespot.com"+"/nudgespot.js";a=document.getElementsByTagName("script");p=a[a.length-1];p.parentNode.insertBefore(s,p.nextSibling);window.nudgespot=n;n.init=function(t){function f(n,m){var a=m.split('.');2==a.length&&(n=n[a[0]],m=a[1]);n[m]=function(){n.push([m].concat(Array.prototype.slice.call(arguments,0)))}}n._version=0.1;n._globals=[t];n.people=n.people||[];n.params=n.params||[];m="track register unregister identify set_config people.delete people.create people.update people.create_property people.tag people.remove_Tag".split(" ");for(var i=0;i<m.length;i++)f(n,m[i])}})(document,window.nudgespot||[]);nudgespot.init("a3b2a04cb8a634716c8f7a599784a8c8");
  ...
  var activity_name = "Seller_cheque_Document_submited";
   nudgespot.track(activity_name);
    ...
    <body>
        ...
        <div  id="nav_bar">
            ...
            <nav class="red" >
                <a href="<?php echo base_url() ?>cancel_document" class="brand-logo center">Document - Cancelled Cheque</a>
                <ul class="left">
        ...
        <main>
            ...
            <div class="row">
                <div class="col l5 offset-l1 m12 s12">
                    <span class="page-title"><?php echo $profile->cancel_status === "Approved" ? "Your" : "Please upload your " ?>  Cancelled Cheque</span>
                    <br/>
                    <span class="page-sub-title">
                        <br/>
                        <?php echo $profile->cancel_status === "Approved" ? "Your document is sucessfully approved" : "Please upload the valid document and wait for verification. If there exists any ambiguilty,our customer care expert will reach you shortly " ?>
                    </span>
                    <br/>
                    <?php
                    $photo_id = "";
                    ...
                    if ($profile->cancel_status === 'N/A') {
                        ...
                        $photo_url = $profile->cancel_cheque;
                    }
                ...
                <?php if ($profile->cancel_status === 'Approved') {
                    ?>
                    <?php
                } else {
                    ?>

                    <div class="col l5 s12 m12 offset-l1">
                        <div class="card-panel">
                            <form method="post" enctype="multipart/form-data" action="<?php echo base_url() ?>cancel_document/upload_document" onsubmit="return validate_form()">
                                <input type="hidden" name="doc_type" value="cancel_cheque"/>
                                <div class="row">
