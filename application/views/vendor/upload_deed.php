...
<html>
    ...
    <body>
        ...
        <div  id="nav_bar">
            ...
            <nav class="red" >
                <a href="<?php echo base_url() ?>deed_document" class="brand-logo center">Document - Partnership Deed</a>
                <ul class="left">
        ...
        <main>
            ...
            <div class="row">
                <div class="col m5 offset-m1">
                    <span class="page-title"><?php echo $profile->deed_status === "Approved" ? "Your" : "Please upload your " ?>  Partnership Deed</span>
                    <br/>
                    <span class="page-sub-title">
                        <br/>
                        <?php echo $profile->deed_status === "Approved" ? "Your document is sucessfully approved" : "After uploading the document please wait for verification. If there exists any ambiguity then we will reach you shortly" ?>
                    </span>
                    <br/>
                    <?php
                    $photo_id = "";
                    $photo_url = "";
                    if ($profile->deed_status === 'N/A') {
                        $photo_id = "N/A";
                        $photo_url = base_url() . "images/documents.png";
                    } else {

                        $photo_url = $profile->part_deed;
                    }
                ...
                <?php if($profile->deed_status !== "Approved") {
                    ?>
                     <div class="col m5 offset-m1">
                    <div class="card-panel">
                        <form method="post" enctype="multipart/form-data" action="<?php echo base_url() ?>deed_document/upload_document" onsubmit="return validate_form()">
                            <input type="hidden" name="doc_type" value="part_deed"/>
                            <div class="row">
