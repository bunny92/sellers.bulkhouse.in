...
<html>
    ...
    <body>
        ...
        <div  id="nav_bar">
            ...
            <nav class="red" >
                <a href="<?php echo base_url() ?>businessinfo/update_business_info_view" class="brand-logo center">Update Your Business Info</a>
                <ul class="left">
            ...
            <br/>
                ...
                <div class="row">
                    <div class="col m10 offset-m1">
                        ...
                        <br/>
                        <br/>
                        <form method="post" action="<?php echo base_url() ?>businessinfo/update_business_details" onsubmit="return validateInfo()">
                        <div class="row">
                            ...
                            <div class="card-panel">
                                        ...
                                        <span class="indigo-text text-darken-4">
                                            <?php
                                                if($this->session->flashdata("message") !== NULL) {
                                                    ...
                                                    if($value === "no") {
                                                       echo "Business info not updated.. Please try again..!";
                                                    }
                                                }
                                            ?>
                                        </span>
                                ...
                                <div class="row">
                                    ...
                                    <br/>
                                    <?php $details = $profile[0] ?>
                                    <table class="width:100%" style="font-size : .9em; color: grey; font-weight: normal">
                                        <tr>
                                            <td style="width:50%">Year of Establishment</td>
                                            <td style="width:50%"><input type="text" id="year" name="year" value="<?=$details->year?>" /> <span id="year_error" style="font-size:.8em; color:red;"></span></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td><select id="no" name="no" class="browser-default">
                                                    ...
                                                    <option value="0 to 50" <?php echo $details->no_of_employees === "0 to 50" ? "selected" : "" ?>>0 to 50</option>
                                                    <option value="50 to 100" <?php echo $details->no_of_employees === "50 to 100" ? "selected" : "" ?>>50 to 100</option>
                                                    <option value="100 and above"> <?php echo $details->no_of_employees === "100 and above" ? "selected" : "" ?></option>
                                                </select><span  id="no_error" style="color:red; font-size:.8em;"></span></td>
                                        </tr>
                                        <tr>
                                            <td>Turn over</td>
                                            <td>
                                                <input type="text" id="turn_over" name="turn_over" value="<?= $details->turn_over?>"/>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select id="certificate" class="browser-default" name="certificate">
                                                    ...
                                                    <option value="ISI/BIS" <?php echo $details->certificate === "ISI/BIS" ? "selected" : "" ?>>ISI/BIS</option>
                                                    <option value='ISO' <?php echo $details->certificate === "ISO" ? "selected" : "" ?>>ISO</option>
                                                    <option value='FSSAI' <?php echo $details->certificate === "FSSAI" ? "selected" : "" ?>>FSSAI</option>
                                                    <option value="NONE" <?php echo $details->certificate === "NONE" ? "selected" : "" ?>>NONE</option>
                                    ...
                                    <table style="width:100%; font-size: .8em; color: grey; font-weight: normal">
                                        <tr>
                                            ...
                                            <td style="width:50%"><input type="text" value="<?= $details->contact_person?>" id="contact_person" name="contact_person"/> <span id="contact_person_error" style="font-size: .8em; color: red"></span></td>
                                        </tr>
                                        <tr>
                                            <td>Contact Email</td>
                                            <td><input type="text" id="contact_email" name="contact_email" value="<?= $details->contact_email?>"/> <span id="contact_email_error" style="font-size:.8em; color:red"></span></td>
                                        </tr>
                                        <tr>
                                            <td>Contact Phone</td>
                                            <td><input type="text" id="contact_phone" name="contact_phone" value="<?= $details->contact_phone?>"/> <span id="contact_phone_error" style="font-size:.8em; color:red"></span></td>
                                        </tr>
                                    </table>
                                </div>
