   ...
   nudgespot.track(activity_name);
    ...
    <body>
        ...
        <div  id="nav_bar">
            ...
            <nav class="red" >
                <a href="<?php echo base_url() ?>pan_document" class="brand-logo center">Document - Personal PAN</a>
                <ul class="left">
        ...
        <main>
            ...
            <div class="row">
                <div class="col m5 offset-m1">
                    <span class="page-title"><?php echo $profile->pan_status === "Approved" ? "Your" : "Please upload your " ?>  PAN Document</span>
                    <br/>
                    ...
                    if ($profile->pan_status === 'N/A') {
                        ...
                        $photo_id = $profile->input_pan;
                        $photo_url = $profile->pan;
                    }
                    ...
                    <span class="page-sub-title">
                        <center>
                            Personal Pan : <?= $photo_id ?>
                        </center>
                    </span>
                </div>
            <?php
                if($profile->pan_status !== "Approved") {
                    ?>
                             <div class="col m5 offset-m1">
                    <div class="card-panel">
                        <form method="post" enctype="multipart/form-data" action="<?php echo base_url() ?>pan_document/upload_document" onsubmit="return validate_form()">
                            <input type="hidden" name="doc_type" value="personal_pan"/>
                            <div class="row">
                                <div class="input-field col s12">
                                    <input id="input_photo_id" name="input_photo_id" type="text"  value="<?php echo $photo_id === "N/A" ? "" : $photo_id ?>" class="validate"/>
                                    <label for="input_photo_id">Enter Personal Pan:</label>
        ...
        <script type="text/javascript">
                             function validate_form() {
                                 ...
                                 if(!(regex.test(pic_id))) {
                                     $("#photo_id_error").html("Please enter valid PAN");
                                     flag = false;
                                 }
