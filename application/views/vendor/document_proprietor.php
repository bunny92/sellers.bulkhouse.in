            ...
            <div class="row">
                <div class="col l4 offset-l1 s12 m12">
                    ...
                    <ol type = '1' style="font-size:.8em; color: gray">
                        ...
                        <li>PAN Card<span style="color:red">*</span></li>
                        <li>CENVAT </li>
                 ...
                 <div class="col s12 l6 m8 offset-m2">
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <span class="page-title">3. PAN Card&nbsp; <span style="color:red; font-size:.8em">*</span></span>
                            <div class="container">
                                <p class="page-sub-title">
                                    <span class="green-text text-darken-1"><?php
                                        if ($this->session->flashdata("pan_message") !== NULL) {
                                            echo $this->session->flashdata("pan_message");
                                        }
                                        ?></span><br/>
                                    Format : JPG or PDF Only <br/>
                                    <span class="indigo-text text-darken-4">Status : <?= $profile->pan_status === 'N/A' ? "Please Upload" : $profile->pan_status ?></span><br/><br/>
                                    <button onclick="document.location.href = '<?php echo base_url() ?>pan_document'" class="btn red white-text" style="font-size: .8em; text-transform: capitalize"><?php
                        ...
                        <div class="row">
                            <span class="page-title">4. CENVAT</span>
                            <div class="container">
                                <p class="page-sub-title">
                                    <span class="green-text text-darken-1"><?php
                        ...
                        <div class="row">
                            <span class="page-title">5. Cancelled Cheque&nbsp; <span style="color:red; font-size:.8em">*</span></span>
                            <div class="container">
                                <p class="page-sub-title">
                                    <span class="green-text text-darken-1"><?php
