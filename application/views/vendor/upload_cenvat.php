...
<html>
    ...
    <body>
        ...
        <div  id="nav_bar">
            ...
            <nav class="red" >
                <a href="<?php echo base_url() ?>cenvat_document" class="brand-logo center">Document - CENVAT</a>
                <ul class="left">
        ...
        <main>
            ...
            <div class="row">
                <div class="col m5 offset-m1">
                    <span class="page-title"><?php echo $profile->cenvat_status === "Approved" ? "Your" : "Please upload your " ?>  CENVAT Document</span>
                    <br/>
                    <span class="page-sub-title">
                        <br/>
                        <?php echo $profile->cenvat_status === "Approved" ? "Your document is sucessfully approved" : "Please upload the valid document and wait for verification. If there exists any ambiguilty,our customer care expert will reach you shortly " ?>
                    </span>
                    <br/>
                    <?php
                    $photo_id = "";
...
<?php if ($profile->cenvat_status !== "Approved") {
    ?>
                    <div class="col m5 offset-m1">
                        <div class="card-panel">
                            <form method="post" enctype="multipart/form-data" action="<?php echo base_url() ?>cenvat_document/upload_document" onsubmit="return validate_form()">
                                <input type="hidden" name="doc_type" value="cenvat"/>
                                <div class="row">
