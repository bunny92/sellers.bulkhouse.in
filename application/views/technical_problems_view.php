                    ...
                    <div class="stepwizard">
                        <div class="stepwizard-row setup-panel">
                            <div class="stepwizard-step">
                                <a href="#" type="btn btn-danger" class="btn  btn-default btn-circle" disabled="disabled">1</a>
                                <p>Information</p>
                            </div>
                            <div class="stepwizard-step">
        ...
        <div class="container-fluid">
            <div class="row vertical-center-row">
                ...
                <div class="col-md-6 col-md-offset-3">
                    <center>
                        <b style="color:red">Sorry for the inconvenience occurred...! We are working on this issue.</b>
                    </center>

                    <center>
                    <span style="font-size:11px;">Please visit us again. If your problem is still not rectified then kindly contact our Administrator</span>
                    </center>
                    <br/>
                    <br/>
                </div>
