    ...
    2: [function(a, b) {
        ...
        b.exports = {
            create: function(a, b) {
                ...
                var h = new d(g),
                    i = new c(g, h);
                if (g.anim = h, b.translate3d(0), h.gotoSlideByIndex(g.options.start), !g.options.disable_scroll) try {
                    f.add(g, h, i, b)
                } catch (j) {}
            }
        }
        ...
        b.exports = {
            apply: function(a, b) {
                a.gotoSlide = function(a) {
                    ...
                    var a = b.$el,
                        c = b.vars;
                    c.parent_width && a.children().width(a.parent().outerWidth(!0)), b.options.disable_autowidth || a.css("width", a.children("li").length * a.children().outerWidth(!0) + 10), c.slideHeight = a.children().height(), c.allSlidesWidth = getCurrentTotalWidth(a), c.velocity = 0, b.anim.gotoSlideByIndex(c.currentIndex, !0)
                }, a.addSlide = function(b) {
                    a.append("<li>" + b + "</li>"), a.reload()
            ...
            function g(a) {
                if (m) {
                    ...
                    if (h.end_animation && !i.disable_slide) {
                        var e = Date.now() - l;
                        j.velocity = -(c.pageX - o) / e, j.direction = j.velocity > 0 ? 1 : -1, j.distanceFromStart = (c.pageX - o) * j.direction * -1;
