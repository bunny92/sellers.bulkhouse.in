...
<div class="main-content">
    <div class="row">
        <span class="page-title">Assign  Agents</span>
        <br/>
        <p class="sub-title-page">
            This page will allow you to allocate agent to the vendor registered
        </p>
    </div>
    <br/>
    <div class="row">
        ...
        <center>
            <table id="myTable" class="table table-bordered table-striped">
                ...
                <tbody>
                    <?php
                    if ($new_registrations !== NULL) {
                        if (count($new_registrations) > 0) {
                            $id = 0;
                            foreach ($new_registrations as $value) {
                                ?> 
                                <tr>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" action="<?= base_url("agents/allocate_agent_to_vendor") ?>" method="post"   onsubmit="return validate_assign()">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-4 col-sm-8">
                            <input type="submit" value="Assign Agent" class="btn btn-default"/>
                        </div>
                    </div>
                </form>
