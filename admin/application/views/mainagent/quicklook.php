        ...
        <nav class="navbar navbar-default navbar-fixed-top">
            <div class="container-fluid">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="<?= base_url("mainagent") ?>"><span class="fa fa-desktop"></span>&nbsp;&nbsp;Quick Look</a></li>
           ...
           <main>
            <div class="container">
                <br/>
                <div class="row">
                    <span class="page-title">Quick Look : AGENT [<?=$this->session->userdata("agent_code")?>]</span>
                    <br/>
