    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="<?= base_url("mainagent/your_vendors") ?>"><span class="fa fa-users"></span>&nbsp;&nbsp;Your Vendors</a></li>
                        <li><a href="<?= base_url("mainagent/rejected_vendors") ?>"><span class="fa fa-user-times"></span>&nbsp;&nbsp;Rejected Vendors</a></li>
        ...
        <main>
            <div class="container">
                <br/>
                <div class="row">
                    <span class="page-title">Your Vendors List: AGENT [<?= $this->session->userdata("agent_code") ?>]</span>
                    <br/>
                                ...
                                if ($look !== NULL) {
                                    ...
                                    foreach ($look as $value) {
                                        ...
                                        if ($value->firm == 1) {
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-info" onclick="getDetails('<?= $value->id ?>', '<?= $value->email ?>', '<?= $value->agent_code ?>')" data-toggle="modal" data-target="#myModal">Click here</button>
                                            </td>
                                        </tr>
                                        <?php
                                    }
        ...
        <script>
                                                    ...
                                                    function getDetails(id, email, agent_code) {
                                                        $("#vendor_id").val(id);
