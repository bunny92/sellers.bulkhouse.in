    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li><a href="<?= base_url("api") ?>"><span class="fa fa-desktop"></span>&nbsp;&nbsp;Magento Sync</a></li>
                        <li><a href="<?= base_url("api/search_magent") ?>"><span class="fa fa-users"></span>&nbsp;&nbsp;Search Email[Magento Sync]</a></li>
                        <li class="active"><a href="<?= base_url("api/crm") ?>"><span class="fa fa-desktop"></span>&nbsp;&nbsp;CRM Sync</a></li>
        ...
        <main>
            <div class="container">
                <br/>
                <div class="row">
                    <span class="page-title">CRM Vendors</span>
                    <br/>
                    <p class="sub-title-page">
                        This page gives you all set of vendors who are waiting to get synchronized with CRM
                    </p>
                </div>
            </div>
            <br/>
