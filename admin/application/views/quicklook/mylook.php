...
<!--                        <li><a href="<?= base_url("statistics") ?>"><span class="fa fa-line-chart"></span>&nbsp;&nbsp;Statistics</a></li>-->
        ...
        <main>
            ...
            <div class="container">
                <br/>
                <form class="form-horizontal" action="<?= base_url("completelook/search") ?>" method="post">
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="from_date">From Date:</label>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4 col-sm-offset-4">
                            <input type="submit" class="btn btn-danger" value="Search Your Vendors"/>
                        </div>
                    </div>
                </form>
            </div>
