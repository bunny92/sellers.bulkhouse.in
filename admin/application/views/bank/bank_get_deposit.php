    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="<?= base_url("bank/get_deposit") ?>"><span class="fa fa-bank"></span>&nbsp;&nbsp;Bank Deposit</a></li>
        ...
        <main>
            <div class="container">
                <br/>
                <div class="row">
                    <span class="page-title">Amount Credited Report</span>
                    <br/>
                    <p class="sub-title-page">
                        This page will display the list of vendors whose accounts are deposited with amount from our Bank 
                    </p>
                </div>
                <br/>
                <br/>
