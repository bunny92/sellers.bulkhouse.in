    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="<?= base_url("bank/deposit") ?>"><span class="fa fa-bank"></span>&nbsp;&nbsp;Bank Verifier</a></li>
                        ...
                        <li><a href="<?= base_url("bank/get_rejected") ?>"><span class="fa fa-bank"></span>&nbsp;&nbsp;Bank Rejected</a></li>
        ...
        <main>
            <div class="container">
                <br/>
                <div class="row">
                    <span class="page-title">Bank Report Exports</span>
                    <br/>
                    <p class="sub-title-page">
                        This page will display the list of vendors whose documents are verified and are waiting for bank approval .
                    </p>
                </div>
                <br/>
                                    ...
                                    if ($private !== NULL) {
                                        foreach ($private as $value) {
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="<?php echo base_url("bank/deposit_amount") ?>?vendor_id=<?= $value->id ?>">Click Here</a></td>
                                                <td><a href="<?php echo base_url("bank/reject_amount") ?>?vendor_id=<?= $value->id ?>">Click Here</a></td>
                                            </tr>
                                            <?php
                                        }
                                    }
