    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="<?= base_url("bank/get_approved") ?>"><span class="fa fa-bank"></span>&nbsp;&nbsp;Bank Approved</a></li>
        ...
        <main>
            <div class="container">
                <br/>
                <div class="row">
                    <span class="page-title">Accounts Approved Report</span>
                    <br/>
                    <p class="sub-title-page">
                        This page will display the list of vendors whose accounts are successfully approved
                    </p>
                </div>
                <br/>
                <br/>
