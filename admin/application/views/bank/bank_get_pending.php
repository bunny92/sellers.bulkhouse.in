    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="<?= base_url("bank/get_pending") ?>"><span class="fa fa-bank"></span>&nbsp;&nbsp;Bank Pending</a></li>
                    </ul>
        ...
        <main>
            <div class="container">
                <br/>
                <div class="row">
                    <span class="page-title">Accounts Pending Report</span>
                    <br/>
                    <p class="sub-title-page">
                        This page will display the list of vendors whose accounts are in pending state.
                    </p>
                </div>
                <br/>
                <br/>
