    ...
    <div class="row">
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            <div class="account-wall" style="background-color:white;border-top: 1px solid #eee;">
                ...
                <p class="profile-name">Bulkhouse Document Admin Portal</p>
                <br/>
                <form class="form-signin" style="background-color:white" action="<?php echo base_url("admin/authenticate_document")?>" method="post">
