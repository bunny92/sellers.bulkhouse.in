    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li><a href="<?= base_url("documents") ?>"><span class="fa fa-users"></span>&nbsp;&nbsp;Documents</a></li>
                        <li class="active"><a href="<?= base_url("documents/quicklook") ?>"><span class="fa fa-desktop"></span>&nbsp;&nbsp;Quick Look</a></li>
                    </ul>
        ...
        <main>
            <div class="container">
                <br/>
                <div class="row">
                    <span class="page-title">Quick Look</span>
                    <br/>
                                        ...
                                        <tr>
                                         ...
                                         <?= $value->email ?>
                                            ...
                                            <td>
                                                ...
                                                if ($value->firm == 1) {
                                                    ?> 
                                                    <?= $value->prop_photo !== NULL ? $value->prop_photo : "Due" ?>
                                                    <?php
                                                } else if ($value->firm == 2) {
                                                    ?>
                                                    <?= $value->partner_photo !== NULL ? $value->partner_photo : "Due" ?>
                                                    <?php
                                                } else if ($value->firm == 3) {
                                                    ?>
                                                    <?= $value->private_photo !== NULL ? $value->private_photo : "Due" ?>
                                                    <?php
                                                }
                                                ?>
                                            </td>
                                            <td>
                                                ...
                                                if ($value->firm == 1) {
                                                    ?> 
                                                    <?= $value->prop_vat !== NULL ? $value->prop_vat : "Due" ?>
                                                    <?php
                                                } else if ($value->firm == 2) {
                                                    ?>
                                                    <?= $value->partner_vat !== NULL ? $value->partner_vat : "Due" ?>
                                                    <?php
                                                } else if ($value->firm == 3) {
                                                    ?>
                                                    <?= $value->private_vat !== NULL ? $value->private_vat : "Due" ?>
                                                    <?php
                                                }
                                                ?>
                                            </td>
                                            <td>
                                                ...
                                                if ($value->firm == 1) {
                                                    ?> 
                                                    <?= $value->prop_pan !== NULL ? $value->prop_pan : "Due" ?>
                                                    <?php
                                                } else if ($value->firm == 2) {
                                                    ?>
                                                    N/A
                                            ...
                                            <td>
                                                ...
                                                if ($value->firm == 1) {
                                                    ...
                                                    ?>
                                                    <?= $value->partner_pan !== NULL ? $value->partner_pan : "Due" ?>
                                                    <?php
                                                } else if ($value->firm == 3) {
                                                    ?>
                                                    <?= $value->private_pan !== NULL ? $value->private_pan : "Due" ?>
                                                    <?php
                                                }
                                                ?>
                                            </td>
                                            <td>
                                                ...
                                                if ($value->firm == 1) {
                                                    ?> 
                                                    <?= $value->prop_cancel !== NULL ? $value->prop_cancel : "Due" ?>
                                                    <?php
                                                } else if ($value->firm == 2) {
                                                    ?>
                                                    <?= $value->partner_cancel !== NULL ? $value->partner_cancel : "Due" ?>
                                                    <?php
                                                } else if ($value->firm == 3) {
                                                    ?>
                                                    <?= $value->private_cancel !== NULL ? $value->private_cancel : "Due" ?>
                                                    <?php
                                                }
                                                ?>
                                            </td>
