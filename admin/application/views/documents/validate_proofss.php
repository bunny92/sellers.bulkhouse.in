                            ...
                            if ($vendors !== NULL) {
                                foreach ($vendors as $value) {
                                    ...
                                    ?> 
                                        ...
                                        <td>
                                <center>
                                    <a class="btn btn-success" href="<?= base_url("privatestatus/change_status?type=" . $type . "&status=Approved&vendor_id=" . $value->id . "&url=" . $url) ?>">Approve</a>
                                    <a class="btn btn-danger" href="<?= base_url("privatestatus/change_status?type=" . $type . "&status=Rejected&vendor_id=" . $value->id . "&url=" . $url) ?>">Reject</a>
                                </center>
                                </td>
                                </tr>
                                <?php
