...
<div class="main-content">
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a href="<?= base_url("dashboard/partner_pending_documents") ?>">Partner Documents</a></li>
        <li><a href="<?= base_url("dashboard/private_pending_documents") ?>">Private Documents</a></li>
    </ul>
    <br/>
    <div class="row main-page" >
        <span class="page-title">Partner - Pending Documents</span>
        <br/>
        <p class="sub-title-page">
            List of vendors whose documents are waiting for verification and are registered for Partnership
        </p>
    </div>
    <br/>
    <div class="row">
                        ...
                        if ($documents !== NULL) {
                            ...
                            foreach ($documents as $value) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                            if($value->deed_status !== NULL) {
                                                echo $value->deed_status;
                                            } else {
                                                echo "Due";
                                            }
                                        ?>
